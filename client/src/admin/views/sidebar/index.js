...
const Sidebar = () => {
  return (
    <aside className="transform lg:translate-x-0 fixed top-0 lg:sticky w-64 z-50 h-screen bg-gray-800 overflow-y-hidden flex flex-col border-r border-gray-200 bg-white flex-shrink-0 transition duration-150 ease-in-out">
